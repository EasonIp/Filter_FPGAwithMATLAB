...
defparam tdl_ff_0_n.LENGTH = 32;
defparam tdl_ff_0_n.DELAY = 0;
msft_data tdl_ff_1_n(.rst(rst), .clk(clk), .clk_en(clk_en), .we(data_ld), .data_in(tdl_dat_1_n_pre),.data_out(tdl_dat_1_n));
defparam tdl_ff_1_n.WIDTH = 32;
defparam tdl_ff_1_n.LENGTH = 32;
...
defparam tdl_rev.LENGTH = 32;
defparam tdl_rev.DELAY = 0;
defparam tdl_rev.IS_ODD = 0;
delay_mux tdl_ff_2_n(.rst(rst), .clk(clk), .clk_en(clk_en), .we(data_ld),.sel(sym_odd_shd), .data_in(data_rev_pre),.data_out_delay(data_rev), .data_out_mux(tdl_dat_1_n_pre));
defparam tdl_ff_2_n.WIDTH = 32;
defparam tdl_ff_2_n.LENGTH = 432;
...
defparam Ucoef_0_n.LENGTH = 32;
defparam Ucoef_0_n.DELAY = 0;
defparam Ucoef_0_n.C0 = 0;
defparam Ucoef_0_n.C1 = 0;
defparam Ucoef_0_n.C2 = 0;
defparam Ucoef_0_n.C3 = 0;
defparam Ucoef_0_n.C4 = 0;
defparam Ucoef_0_n.C5 = 0;
defparam Ucoef_0_n.C6 = 0;
defparam Ucoef_0_n.C7 = 0;
defparam Ucoef_0_n.C8 = 0;
defparam Ucoef_0_n.C9 = 0;
defparam Ucoef_0_n.C10 = 0;
defparam Ucoef_0_n.C11 = 2047;
defparam Ucoef_0_n.C12 = 0;
defparam Ucoef_0_n.C13 = 0;
defparam Ucoef_0_n.C14 = 0;
defparam Ucoef_0_n.C15 = 0;
...
defparam Ucoef_0_n.C27 = 1241;
defparam Ucoef_0_n.C28 = 3819;
defparam Ucoef_0_n.C29 = 69;
defparam Ucoef_0_n.C30 = 4086;
defparam Ucoef_0_n.C31 = 0;
...
wire [44:0] fir_acc_in;
wire [44:0] fir_temp_res;
wire [44:0] fir_acc_in_reg;
...
.done_int(done_int), .rdy_int(rdy_int), .rev_copy(rev_copy), .data_ld(data_ld), .sym_odd_shd(sym_odd_shd),
.done(done), .rdy_to_ld(rdy_to_ld));
defparam ctrl.REG_LEN   = 16;
defparam ctrl.DECI_FACT   = 2;
defparam ctrl.DECI_WIDTH   = 1;
defparam ctrl.PIPE_DLY  = 41;
defparam ctrl.PIPE_WIDTH  = 6;
