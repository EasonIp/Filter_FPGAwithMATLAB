...
%LSB Truncated bits:
%LSB Rounded bits  :
%FIR Width (Full Calculation Width Before Output Width Adjust) :44 
%-----------------------------------------------------------------------------------------------------------
%MegaWizard Scaled Coefficient Values
 function  output = hf_3_mlab(stimulation, output);
 coef_matrix=[-65,0,577,1024,577,0,-65];
 INTER_FACTOR  = 1;         
 DECI_FACTOR  =  2;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
