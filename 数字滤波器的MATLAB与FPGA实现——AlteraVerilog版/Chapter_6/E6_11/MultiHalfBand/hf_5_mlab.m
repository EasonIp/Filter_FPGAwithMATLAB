...
%LSB Truncated bits:
%LSB Rounded bits  :
%FIR Width (Full Calculation Width Before Output Width Adjust) :45 
%-----------------------------------------------------------------------------------------------------------
%MegaWizard Scaled Coefficient Values
 function  output = hf_5_mlab(stimulation, output);
 coef_matrix=[-10,0,69,0,-277,0,1241,2047,1241,0,-277,0,69,0,-10];
 INTER_FACTOR  = 1;         
 DECI_FACTOR  =  2;
 MSB_RM  = 0;
 MSB_TYPE  = 0;
