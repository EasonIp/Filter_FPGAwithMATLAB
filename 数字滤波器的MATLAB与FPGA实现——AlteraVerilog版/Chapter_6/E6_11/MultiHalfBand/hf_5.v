...
module hf_5 (
	...
	output	[44:0]	ast_source_data;
	output		ast_sink_ready;
	output		ast_source_valid;
	output	[1:0]	ast_source_error;


	hf_5_ast	hf_5_ast_inst(
		.clk(clk),
		.reset_n(reset_n),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FIRModelClass"  active_core="hf_5_ast" >
...
// Retrieval info:      <PRIVATE name = "coefficient_scaling_factor" value="4094.0"  type="STRING"  enable="0" />
...
// Retrieval info:      <PRIVATE name = "output_bit_width" value="45"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "clocks_to_compute" value="16"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "max_clocks_to_compute" value="8"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "set_1" value="Low Pass Set, Imported, D:\FilterVerilog\Chapter_6\E6_11\E6_11_hf5.txt, -0.0024739462, 0.0, 0.016964639, 0.0, -0.0676776, 0.0, 0.3031699, 0.5, 0.3031699, 0.0, -0.0676776, 0.0, 0.016964639, 0.0, -0.0024739462"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "number_of_sets" value="1"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "output_full_bit_width" value="45"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "logic_cell" value="2162"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "output_clock_period" value="32"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "throughput" value="32"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="hf_5.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: hf_5_st.v, hf_5_constraints.tcl, hf_5_ast.vhd, hf_5.v, hf_5_ast.vhd, hf_5.v;
// IPFS_FILES: hf_5.vo;
// =========================================================
