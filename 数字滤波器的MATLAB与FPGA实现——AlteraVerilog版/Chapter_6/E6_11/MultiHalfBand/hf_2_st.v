...
defparam tdl_ff_1_n.WIDTH = 20;
defparam tdl_ff_1_n.LENGTH = 4;
defparam tdl_ff_1_n.DELAY = 0;
msft_data_reseq tdl_rev(.rst(rst), .clk(clk),.clk_en(clk_en), .we(data_ld), .copy(rev_copy),.data_in(data_in_mux),.data_out(data_rev_pre));
defparam tdl_rev.WIDTH = 20;
defparam tdl_rev.LENGTH = 4;
...
defparam Ucoef_0_n.C0 = 4032;
defparam Ucoef_0_n.C1 = 1024;
defparam Ucoef_0_n.C2 = 0;
defparam Ucoef_0_n.C3 = 576;


wire [32:0] mlu_resx_0_n;
mlu_nd Umlu_0_n (.clk(clk), .data_in(sym_res_0_n), .coef_in(coef_st_0_n), .clk_en(clk_en), .mlu_out(mlu_resx_0_n) );
defparam Umlu_0_n.DATA_WIDTH = 21;
defparam Umlu_0_n.COEF_WIDTH = COEF_WIDTH;
defparam Umlu_0_n.PIPE = 3;
defparam Umlu_0_n.DSP_USE = "YES";
wire [32:0] mlu_res_0_n;
mac_tl Umtl_0_n             (.clk(clk), 
             .data_in(mlu_resx_0_n),
             .data_out(mlu_res_0_n));
defparam Umtl_0_n.DATA_WIDTH = 33;

wire [33:0] tree_l_0_n_0_n;
sadd_reg_top_cen Uaddl_0_n_0_n (.clk(clk),  .gclk_en(clk_en), .ain(mlu_res_0_n), .bin(33'd0), .res(tree_l_0_n_0_n) );
defparam Uaddl_0_n_0_n.IN_WIDTH = 33;
defparam Uaddl_0_n_0_n.PIPE_DEPTH = 1;

wire [33:0] fir_mc_res;
assign fir_mc_res=tree_l_0_n_0_n;
wire [31:0] fir_acc_in;
wire [31:0] fir_temp_res;
wire [31:0] fir_acc_in_reg;
