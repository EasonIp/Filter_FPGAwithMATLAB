...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% CicFilter_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    CicFilter_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    CicFilter_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    CicFilter_fir_comp_coeff(31,80e6,4e6,true,false)


function CicFilter_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	...
	filename = 'CicFilter_fir_comp_coeff.txt';
