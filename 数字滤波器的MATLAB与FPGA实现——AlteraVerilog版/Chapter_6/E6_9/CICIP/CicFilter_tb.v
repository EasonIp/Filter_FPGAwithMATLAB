...
// inputs
  ...
  parameter              MAXVAL_c = 65536;
  parameter              OFFSET_c = 131071;

   initial
   begin
      data_file_in = $fopen("CicFilter_tb_input.txt","r");
      data_file_out = $fopen("CicFilter_tb_output.txt");
