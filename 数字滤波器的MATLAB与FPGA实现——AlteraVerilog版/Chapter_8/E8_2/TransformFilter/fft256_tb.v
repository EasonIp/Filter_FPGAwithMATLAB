...
initial
   begin
     ...
     fftpts_array[2]=256;
     fftpts_array[3]=256;
     data_rf = $fopen("fft256_real_input.txt","r");
     data_if = $fopen("fft256_imag_input.txt","r");
     fft_rf = $fopen("fft256_real_output_ver.txt");
     fft_if =$fopen("fft256_imag_output_ver.txt");
     expf = $fopen("fft256_exponent_output_ver.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
