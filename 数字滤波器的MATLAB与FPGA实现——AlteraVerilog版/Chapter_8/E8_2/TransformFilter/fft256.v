...
module fft256 (
	...
	asj_fft_si_sose_so_b_fft_121	asj_fft_si_sose_so_b_fft_121_inst(
		.clk(clk),
		.reset_n(reset_n),
		.inverse(inverse),
	...
	defparam
		asj_fft_si_sose_so_b_fft_121_inst.nps = 256,
		asj_fft_si_sose_so_b_fft_121_inst.bfp = 1,
		asj_fft_si_sose_so_b_fft_121_inst.nume = 1,
		asj_fft_si_sose_so_b_fft_121_inst.mpr = 16,
		asj_fft_si_sose_so_b_fft_121_inst.twr = 16,
		asj_fft_si_sose_so_b_fft_121_inst.bpr = 16,
		asj_fft_si_sose_so_b_fft_121_inst.bpb = 4,
		asj_fft_si_sose_so_b_fft_121_inst.fpr = 4,
		asj_fft_si_sose_so_b_fft_121_inst.mram = 0,
		asj_fft_si_sose_so_b_fft_121_inst.m512 = 0,
		asj_fft_si_sose_so_b_fft_121_inst.mult_type = 0,
		asj_fft_si_sose_so_b_fft_121_inst.mult_imp = 0,
		asj_fft_si_sose_so_b_fft_121_inst.dsp_arch = 0,
		asj_fft_si_sose_so_b_fft_121_inst.srr = "AUTO_SHIFT_REGISTER_RECOGNITION=OFF",
		asj_fft_si_sose_so_b_fft_121_inst.rfs1 = "fft256_1n256sin.hex",
		asj_fft_si_sose_so_b_fft_121_inst.rfs2 = "fft256_2n256sin.hex",
		asj_fft_si_sose_so_b_fft_121_inst.rfs3 = "fft256_3n256sin.hex",
		asj_fft_si_sose_so_b_fft_121_inst.rfc1 = "fft256_1n256cos.hex",
		asj_fft_si_sose_so_b_fft_121_inst.rfc2 = "fft256_2n256cos.hex",
		asj_fft_si_sose_so_b_fft_121_inst.rfc3 = "fft256_3n256cos.hex";
endmodule
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.FFTModelClass"  active_core="asj_fft_si_sose_so_b_fft_121" >
...
// Retrieval info:      <PRIVATE name = "OPR" value="25"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_LE" value="1566"  type="INTEGER"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_M4K" value="1"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_MEMBITS" value="12288"  type="INTEGER"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="fft256.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="fft256_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// =========================================================
// RELATED_FILES: fft256.v;
// IPFS_FILES: fft256.vo;
// =========================================================
