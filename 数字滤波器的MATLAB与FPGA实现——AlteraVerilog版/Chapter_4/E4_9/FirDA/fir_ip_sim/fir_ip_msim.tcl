...
if {[string match $flow "rtl"] } {
    ...
    if {[file exists fir_ip.vhd]} {vcom -93 -work work fir_ip.vhd}
    if {[file exists fir_ip.v]} {vlog -work work fir_ip.v}
    vcom -93 -work work fir_ip_ast.vhd
    vcom -93 -work work fir_ip_rtl.vhd
