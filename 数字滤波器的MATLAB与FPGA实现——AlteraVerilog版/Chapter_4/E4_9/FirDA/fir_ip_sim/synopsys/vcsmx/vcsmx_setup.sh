...
# ACDS 12.1 177 win32 2014.05.28.21:55:36
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vhdlan                "c:/altera/12.1/quartus/eda/sim_lib/cycloneive_atoms.vhd"             -work cycloneive      
  vhdlan                "c:/altera/12.1/quartus/eda/sim_lib/cycloneive_components.vhd"        -work cycloneive      
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/fir_ip_rtl.vhd"                                 
  vhdlan -xlrm "$QSYS_SIMDIR/fir_ip_ast.vhd"                                 
  vhdlan -xlrm "$QSYS_SIMDIR/fir_ip.vhd"                                     
  vhdlan -xlrm "$QSYS_SIMDIR/fir_ip_tb.vhd"                                  
fi
